...
Current comparison: ShapesDemo2D - copy and do a diff.  I was trying to find a good inline diff tool so text differences are easier to spot in this format, but nothing would output the similarities and then point out the line differences.  Hopefully I'll find something better with a bit more searching.
